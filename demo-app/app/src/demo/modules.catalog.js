...
export const MODULE_CATALOG = [
  ...
  },
  {
    ...
    tier: 'addon',
    price: 600,
    blurb: 'Your field dispatch center — assign and route crews, push jobs to a mobile app, and track completion live, the way platforms like Jobber do.',
    longDescription:
      'Field Ops is your dispatch center. It turns the schedule into live dispatch — send jobs to a mobile field app, assign and re-route crews on the fly, and watch status roll in as work gets done. Crews run digital checklists, capture before/after photos, and confirm completion with GPS, even offline. It’s the field-service dispatch backbone you’d reach for a tool like Jobber to get, built natively into PolishPoint.',
    features: [
      'Live dispatch board',
      'Assign & re-route crews on the fly',
